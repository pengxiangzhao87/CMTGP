...
(function ($)
{
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        hasChildren: function (treenodedata)
        {
            ...
            return (treenodedata.children && treenodedata.children.length)? true : false;
        },
        //获取父节点 数据
        ...
        getCheckedByType: function (type)
        {
            ...
            {
                var treedataindex = parseInt($(this).attr("treedataindex"));
                var checkNode = g._getDataNodeByTreeDataIndex(g.data, treedataindex);
                if(typeof(type)=="undefined"){
                	nodes.push({ target: this, data: checkNode });
            	}else if(typeof(checkNode['orgType'])=="undefined"){
            		
            	}else{
            		if(checkNode['orgType'] == type){
            			nodes.push({ target: this, data: checkNode });
            		}
            	}
            });
