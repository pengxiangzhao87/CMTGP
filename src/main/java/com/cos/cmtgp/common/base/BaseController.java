package com.cos.cmtgp.common.base;
...
import com.cos.cmtgp.business.model.SysLog;
import com.cos.cmtgp.business.model.UserSetting;
import com.cos.cmtgp.common.util.Pager;
import com.cos.cmtgp.common.util.StringUtil;
import com.cos.cmtgp.common.vo.QueryParamVO;
...
public class BaseController extends Controller {
	...
	/**
	 * 增加操作日志
	 * @param opContent 操作内容格式    用户管理-用户新增
	 */
	protected void addOpLog(String opContent) {
		SysLog sysLog =getModel(SysLog.class, "model");
		sysLog.set("content", opContent);
		sysLog.set("date_time", new Date());
		sysLog.save();
	}
